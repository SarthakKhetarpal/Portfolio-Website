...
export const CodingProfileCard = ({icon,total,loading}) => {
  return (
    <div className='flex flex-row gap-10 p-6 sm:p-8 md:p-10 justify-center items-center z-30 transition-all duration-200
    border-[1px] border-opacity-40 border-richblack-950 hover:shadow-lg hover:shadow-black hover:scale-110
    rounded-lg'>

        <img width={125} src={icon} loading='lazy' alt='Logo'/>
